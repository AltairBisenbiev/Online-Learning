...
if (isset($_POST['save']))
{
	...
	mysqli_query($db,"UPDATE test_java_question SET question='$question' WHERE nomer_variant='$nomer_variant' AND nomer_question='$nomer_question' ");
	$correctTo=0;
		...
		if(isset($_POST['answer_1'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_1',correct='$correctTo'  WHERE id='$variant_1'  ");
		}
		if(isset($_POST['answer_2'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_2',correct='$correctTo'  WHERE id='$variant_2' ");
		}
		if(isset($_POST['answer_3'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_3',correct='$correctTo'   WHERE id='$variant_3'  ");
		}
		if(isset($_POST['answer_4'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_4',correct='$correctTo'   WHERE id='$variant_4'  ");
		}
		if(isset($_POST['answer_5'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_5',correct='$correctTo'  WHERE id='$variant_5'  ");
		}
		if(isset($_POST['answer_6'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_6',correct='$correctTo'  WHERE id='$variant_6' ");
		}
		if(isset($_POST['answer_7'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_7',correct='$correctTo'   WHERE id='$variant_7' ");
		}
		if(isset($_POST['answer_8'])) 
		{
			...
			mysqli_query($db,"UPDATE test_java_answer SET answer='$answer_8',correct='$correctTo'  WHERE id='$variant_8'  ");
		}
		mysqli_close($db);
		echo "<script type='text/javascript'>window.location.href = 'test_java_edit.php';</script>";;
}
...
$data=mysqli_query($db,"SELECT * FROM test_java_question WHERE nomer_variant='$variant' AND nomer_question='$question'");
...
<?php
$data2=mysqli_query($db,"SELECT * FROM test_java_answer WHERE nomer_variant='$variant' AND nomer_question='$question'");
$c=1;$d=1;
