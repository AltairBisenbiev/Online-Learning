...
<a href="keyterms_css_add.php" class="btn btn btn-info my-5">ADD NEW KEYTERMS</a>
<table class="table table-sm table-responsive-sm table-striped table-bordered  "  id="dataTable"  >
  ...
  <tbody>
  	...
  	<td>
  		<form method="POST" action="keyterms_css_delete.php">
  	...
  	<td>
  		<form method="POST" action="keyterms_css_edit.php">
  			<input type="hidden" name="id" value="<?php echo $row['id'];?>">
