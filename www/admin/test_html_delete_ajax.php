...
if (isset($_POST['link']))
{
  ...
  <tbody>
  	<?php
  	$datatable=mysqli_query($db,"SELECT * FROM test_html_question WHERE nomer_variant='$link'  ORDER BY nomer_question ASC");
    ...
    <tr>
      ...
      <td class="text-center"><form method="POST" action="test_html_deleting.php">
