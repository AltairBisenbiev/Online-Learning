...
if (isset($_POST['save']))
{
	...
	require_once '../connect.php';
 	$data=mysqli_query($db,"SELECT * FROM test_java_question WHERE nomer_variant='$nomer_variant' AND nomer_question='$nomer_question' ") or die (mysql_error());
	$record=mysqli_num_rows($data);
if ($record<1){
	//echo $question.'  '.$nomer_variant.'  '.$nomer_question;	
	mysqli_query($db,"INSERT INTO test_java_question (nomer_variant,nomer_question,question) VALUES ('$nomer_variant','$nomer_question','$question')") or die(mysqli_error($db));
...
$correctTo=0;
		...
		if(isset($_POST['answer_1'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_1','$answer_1','$correctTo')") or die(mysqli_error($db));
		}
		if(isset($_POST['answer_2'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_2','$answer_2','$correctTo')") or die(mysqli_error($db));
		}
		if(isset($_POST['answer_3'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_3','$answer_3','$correctTo')") or die(mysqli_error($db));
		}
		if(isset($_POST['answer_4'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_4','$answer_4','$correctTo')") or die(mysqli_error($db));
		}
		if(isset($_POST['answer_5'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_5','$answer_5','$correctTo')") or die(mysqli_error($db));
		}
		if(isset($_POST['answer_6'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_6','$answer_6','$correctTo')");
		}
		if(isset($_POST['answer_7'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_7','$answer_7','$correctTo')");
		}
		if(isset($_POST['answer_8'])) 
		{
			...
			mysqli_query($db,"INSERT INTO test_java_answer (nomer_variant,nomer_question,variant_answer,answer,correct) VALUES ('$nomer_variant','$nomer_question','$variant_8','$answer_8','$correctTo')");
		}
		mysqli_close($db);
	}else
	{
...
<div class="container">
 ...
 <div class="row">
 	<div class="col-lg-3 col-sm-12 my-1">
 		<a href="test_java_add.php" style="text-decoration: none;">
 			<span class="btn btn-success btn-block">ADD QUESTION</span>
 		</a>
 	</div>
 	<div class="col-lg-3 col-sm-12 my-1">
 		<a href="test_java_delete.php"  style="text-decoration: none;">
 			<span class="btn btn-danger btn-block">DELETE QUESTION</span>
 		</a>
 	</div>
 	<div class="col-lg-3 col-sm-12 my-1">
 		<a href="test_java_edit.php"  style="text-decoration: none;">
		...
		<div class="modal-content">
			...
			<div >				
				<div class="form-group">
					<form method="GET" action="test_java_add_module.php">
...
<span name='form_inner2' id='form_inner2'>
