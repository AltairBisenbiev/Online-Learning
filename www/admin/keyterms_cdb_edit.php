...
if(isset($_POST['save'])){
	...
	$english=$_POST['eng'];
	require '../connect.php';
	mysqli_query($db,"UPDATE keyterms_cdb SET kaz='$kazakh',rus='$russian',eng='$english' WHERE id='$kid'");
	mysqli_close($db);
	echo "<script type='text/javascript'>alert('Editing finish succesfully!'); window.location.href='keyterms_cdb.php';</script>";
}
/////////////////////////////////////////
require "header.php";
?>
<div class="container-fluid">
	...
	require '../connect.php';
	$id=$_POST['id'];
	$result=mysqli_query($db,"SELECT * FROM keyterms_cdb WHERE id='$id'");
